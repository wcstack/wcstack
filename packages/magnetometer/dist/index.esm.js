...
class MagnetometerCore extends EventTarget {
    static wcBindable = {
        ...
        version: 1,
        properties: [
            { name: "x", event: "wcs-magnetometer:reading", semantics: "state", getter: (e) => e.detail.x },
            { name: "y", event: "wcs-magnetometer:reading", semantics: "state", getter: (e) => e.detail.y },
            { name: "z", event: "wcs-magnetometer:reading", semantics: "state", getter: (e) => e.detail.z },
