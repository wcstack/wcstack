...
class ClipboardCore extends EventTarget {
    static wcBindable = {
        ...
        version: 1,
        properties: [
            { name: "text", event: "wcs-clipboard:read", semantics: "event", getter: (e) => e.detail.text },
            { name: "items", event: "wcs-clipboard:read", semantics: "event", getter: (e) => e.detail.items },
            ...
            { name: "copied", event: "wcs-clipboard:copied", semantics: "event", getter: (e) => e.detail },
            { name: "cut", event: "wcs-clipboard:cut", semantics: "event", getter: (e) => e.detail },
            { name: "pasted", event: "wcs-clipboard:pasted", semantics: "event", getter: (e) => e.detail },
        ],
        commands: [
