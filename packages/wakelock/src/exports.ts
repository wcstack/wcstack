...
// Typed element lookups (docs/typescript.md §3): `document.querySelector("wcs-wakelock")`
...
// (`import "@wcstack/wakelock"` or a tsconfig `types` entry).
import type { WcsWakeLock } from "./components/WakeLock.js";
declare global {
