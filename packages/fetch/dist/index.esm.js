...
function reportTrustedTypesBlock() {
    if (_reported)
        return;
    _reported = true;
    ...
    console.error(`[@wcstack/fetch] The "target" HTML replace mode was blocked by Trusted Types `
 ...
 */
function writeTargetHTML(element, html) {
    try {
        element.innerHTML = trustHtmlValue(html);
    }
    catch (error) {
