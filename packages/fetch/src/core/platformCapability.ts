/**
 * platformCapability.ts
 *
 * Phase 6(docs/architecture-hardening/09-remediation-design.md §7.2 /
 * 07-browser-capability-variance.md)の browser capability 判定と error taxonomy。
 *
 * 原則:
 ...
 *
 * 配置(§14): fetch ローカルの copy-distribution helper(OperationLane と同様)。
 * 2 ノード以上が必要とし形が固まったら共有パッケージへ昇格する。
 *
