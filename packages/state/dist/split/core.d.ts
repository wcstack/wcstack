export { I as IStateFeature, i as installFeatures } from './chunks/features.js';
...
declare function bootstrapCore(config?: IWritableConfig, registry?: CustomElementRegistry): void;
...
export { TRUSTED_TYPES_POLICY_SLOT, VERSION, bootstrapCore as bootstrapState, buildBindings, defineState, getBindingsReady, getConfig, getTrustedTypesPolicy, setTrustedTypesPolicy };
export type { IBindingErrorInfo, IWcsTrustedTypesPolicy, IWritableConfig, IWritableTagNames, WcsPathValue, WcsPaths, WcsStateApi, WcsThis };
