...
// Typed element lookups (docs/typescript.md §3): `document.querySelector("wcs-gyroscope")`
...
// (`import "@wcstack/gyroscope"` or a tsconfig `types` entry).
import type { WcsGyroscope } from "./components/Gyroscope.js";
declare global {
