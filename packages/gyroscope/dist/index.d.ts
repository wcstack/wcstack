 ...
 */
interface WcsGyroscopeErrorDetail {
    error: string;
    message: string;
}
/**
 ...
 * ```
 */
interface WcsGyroscopeCoreValues extends WcsGyroscopeReading {
...
export type { IWritableConfig, IWritableTagNames, WcsGyroscopeCoreValues, WcsGyroscopeErrorDetail, WcsGyroscopeReading, WcsGyroscopeValues };
