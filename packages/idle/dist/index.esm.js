...
class IdleCore extends EventTarget {
    static wcBindable = {
        ...
        version: 1,
        properties: [
            { name: "userState", event: "wcs-idle:change", semantics: "state", getter: (e) => e.detail.userState },
            { name: "screenState", event: "wcs-idle:change", semantics: "state", getter: (e) => e.detail.screenState },
            {
                name: "active",
