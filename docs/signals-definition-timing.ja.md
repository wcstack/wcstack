...
- **関連**: [signals-state-design.ja.md](./signals-state-design.ja.md)（bindNode の設計原点 §3）、[defined-tag-design.md](./defined-tag-design.md)（`<wcs-defined>` = whenDefined の失敗セマンティクス補完）、`packages/signals/README.md`（mountNode の利用者向け正本）
- **日付**: 2026-07-28
- **English**: [signals-definition-timing.md](./signals-definition-timing.md)
