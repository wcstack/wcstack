...
- **English**: [13-framework-adapter-binding-constraints.md](13-framework-adapter-binding-constraints.md)

## 結論

[React の不変スナップショット](11-react-immutable-snapshot-boundary.md) と
[observable 棚卸し](12-wc-bindable-observable-inventory.ja.md) は「配送された値の意味」を扱う。本書はその手前、
...
同型の問題は signals 側で既に決着させている（[定義タイミング規範](../signals-definition-timing.ja.md)、
...
adapter を使わず直接束縛する経路と、[棚卸し §5.6](12-wc-bindable-observable-inventory.ja.md) が指摘した
...
- [signals の定義タイミング規範](../signals-definition-timing.ja.md)
