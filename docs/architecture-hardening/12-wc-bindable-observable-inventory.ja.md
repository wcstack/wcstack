...
- **English**: [12-wc-bindable-observable-inventory.md](12-wc-bindable-observable-inventory.md)
...
バインド成立可否の問題なので、[framework adapter のバインド成立制約](13-framework-adapter-binding-constraints.ja.md)
で扱う。
