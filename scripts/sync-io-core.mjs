...
const PACKAGE_FILES = {
  ...
  storage: CAPABILITY_ONLY,
  accelerometer: CAPABILITY_ONLY,
  gyroscope: CAPABILITY_ONLY,
  ...
  worker: CAPABILITY_ONLY,
  broadcast: CAPABILITY_ONLY,
  idle: CAPABILITY_ONLY,
  websocket: CAPABILITY_ONLY,
  sse: CAPABILITY_ONLY,
  camera: CAPABILITY_ONLY,
  speech: CAPABILITY_ONLY,
  fullscreen: CAPABILITY_ONLY,
  "picture-in-picture": CAPABILITY_ONLY,
