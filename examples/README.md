...
| [`state-intersect-scroll/`](state-intersect-scroll/) | intersection + state (`$streams` switchMap restart + bounded retry, `$scan` feed accumulation) | `node examples/state-intersect-scroll/server.js` | :3000 |
