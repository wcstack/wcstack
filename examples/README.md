...
| [`state-intersect-scroll/`](state-intersect-scroll/) | intersection + state (`$stream` switchMap restart + bounded retry, `$scan` feed accumulation) | `node examples/state-intersect-scroll/server.js` | :3000 |
